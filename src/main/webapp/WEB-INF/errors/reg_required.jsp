...
<html>
<head>
    <title><fmt:message key="error.reg.req.title"/></title>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="error-template">
                ...
                <h2><fmt:message key="error.reg.req"/></h2>
                <div class="error-details">
                    <fmt:message key="error.reg.req.instr"/>
                </div>
                <div class="error-actions">
                    ...
                    <a href="${pageContext.request.contextPath}/page/reg_fwd?curLang=${sessionScope.curLang}"
                       class="btn btn-default btn-lg"><span
                            class="glyphicon glyphicon-envelope"></span> <fmt:message key="error.register"/> </a>
                </div>
            </div>
        </div>
    </div>
